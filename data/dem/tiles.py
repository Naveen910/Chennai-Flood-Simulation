...
def delineate_basins(dem_path, output_dir, flow_accum_threshold, max_influence_distance):
    ...
    flow_accum_threshold (int): Threshold for stream extraction.
    max_influence_distance (float): Maximum distance for influence area.
    """
...
if __name__ == "__main__":
    dem_path = r"D:\ABN\chennai\chennai-water-log\data\dem\dem.tif"
    output_dir = r"D:\ABN\chennai\tiles"
